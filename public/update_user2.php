...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $photoData = $user['photo']; // keep old photo
    ...
    $sql = "UPDATE tblusers
            SET username=?, first_name=?, last_name=?, email=?, gender=?, mobile=?, userrole=?, photo=?
            WHERE user_id=?";
...
<body>
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data">
            <input name="username" value="<?= htmlspecialchars($user['username']) ?>"><br><br>
            <input name="first_name" value="<?= htmlspecialchars($user['first_name']) ?>"><br><br>
            <input name="last_name" value="<?= htmlspecialchars($user['last_name']) ?>"><br><br>
            <input name="email" value="<?= htmlspecialchars($user['email']) ?>"><br><br>
            <input name="mobile" value="<?= htmlspecialchars($user['mobile']) ?>"><br><br>
